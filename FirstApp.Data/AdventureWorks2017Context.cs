...
namespace FirstApp.Data
{
    public partial class AdventureWorks2017Context : DbContext
    {
        ...
        public virtual DbSet<ReplicaCurrency> ReplicaCurrency { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=CVYS7QIWOHVH7E2\\MSSQLSERVER01,1433;Database=AdventureWorks2017_New;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ReplicaCurrency>(entity =>
            {
                entity.HasKey(e => e.CurrencyCode);

                entity.ToTable("ReplicaCurrency", "Sales");
