...
{
    public partial class adventureWorksNew : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SystemInformationID = table.Column<byte>(nullable: false, comment: "Primary key for AWBuildVersion records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DatabaseVersion = table.Column<string>(name: "Database Version", maxLength: 25, nullable: false, comment: "Version number of the database in 9.yy.mm.dd.00 format."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DatabaseLogID = table.Column<int>(nullable: false, comment: "Primary key for DatabaseLog records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PostTime = table.Column<DateTime>(type: "datetime", nullable: false, comment: "The date and time the DDL change occurred."),
                    DatabaseUser = table.Column<string>(maxLength: 128, nullable: false, comment: "The user who implemented the DDL change."),
                    Event = table.Column<string>(maxLength: 128, nullable: false, comment: "The type of DDL statement that was executed."),
                    Schema = table.Column<string>(maxLength: 128, nullable: true, comment: "The schema to which the changed object belongs."),
                    Object = table.Column<string>(maxLength: 128, nullable: true, comment: "The object that was changed by the DDL statment."),
                    TSQL = table.Column<string>(nullable: false, comment: "The exact Transact-SQL statement that was executed."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ErrorLogID = table.Column<int>(nullable: false, comment: "Primary key for ErrorLog records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    UserName = table.Column<string>(maxLength: 128, nullable: false, comment: "The user who executed the batch in which the error occurred."),
                    ErrorNumber = table.Column<int>(nullable: false, comment: "The error number of the error that occurred."),
                    ErrorSeverity = table.Column<int>(nullable: true, comment: "The severity of the error that occurred."),
                    ErrorState = table.Column<int>(nullable: true, comment: "The state number of the error that occurred."),
                    ErrorProcedure = table.Column<string>(maxLength: 126, nullable: true, comment: "The name of the stored procedure or trigger where the error occurred."),
                    ErrorLine = table.Column<int>(nullable: true, comment: "The line number at which the error occurred."),
                    ErrorMessage = table.Column<string>(maxLength: 4000, nullable: false, comment: "The message text of the error that occurred.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DepartmentID = table.Column<short>(nullable: false, comment: "Primary key for Department records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Name of the department."),
                    GroupName = table.Column<string>(maxLength: 50, nullable: false, comment: "Name of the group to which the department belongs."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShiftID = table.Column<byte>(nullable: false, comment: "Primary key for Shift records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Shift description."),
                    StartTime = table.Column<TimeSpan>(nullable: false, comment: "Shift start time."),
                    EndTime = table.Column<TimeSpan>(nullable: false, comment: "Shift end time."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AddressTypeID = table.Column<int>(nullable: false, comment: "Primary key for AddressType records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Address type description. For example, Billing, Home, or Shipping."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Primary key for all customers, vendors, and employees.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContactTypeID = table.Column<int>(nullable: false, comment: "Primary key for ContactType records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Contact type description."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CountryRegionCode = table.Column<string>(maxLength: 3, nullable: false, comment: "ISO standard code for countries and regions."),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Country or region name."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PhoneNumberTypeID = table.Column<int>(nullable: false, comment: "Primary key for telephone number type records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Name of the telephone number type"),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CultureID = table.Column<string>(fixedLength: true, maxLength: 6, nullable: false, comment: "Primary key for Culture records."),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Culture description."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IllustrationID = table.Column<int>(nullable: false, comment: "Primary key for Illustration records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LocationID = table.Column<short>(nullable: false, comment: "Primary key for Location records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Location description."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductCategoryID = table.Column<int>(nullable: false, comment: "Primary key for ProductCategory records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Category description."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductDescriptionID = table.Column<int>(nullable: false, comment: "Primary key for ProductDescription records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Description = table.Column<string>(maxLength: 400, nullable: false, comment: "Description of the product."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductModelID = table.Column<int>(nullable: false, comment: "Primary key for ProductModel records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Product model description."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductPhotoID = table.Column<int>(nullable: false, comment: "Primary key for ProductPhoto records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ThumbNailPhoto = table.Column<byte[]>(nullable: true, comment: "Small image of the product."),
                    ThumbnailPhotoFileName = table.Column<string>(maxLength: 50, nullable: true, comment: "Small image file name."),
                    LargePhoto = table.Column<byte[]>(nullable: true, comment: "Large image of the product."),
                    LargePhotoFileName = table.Column<string>(maxLength: 50, nullable: true, comment: "Large image file name."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScrapReasonID = table.Column<short>(nullable: false, comment: "Primary key for ScrapReason records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Failure description."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransactionID = table.Column<int>(nullable: false, comment: "Primary key for TransactionHistoryArchive records."),
                    ProductID = table.Column<int>(nullable: false, comment: "Product identification number. Foreign key to Product.ProductID."),
                    ReferenceOrderID = table.Column<int>(nullable: false, comment: "Purchase order, sales order, or work order identification number."),
                    ReferenceOrderLineID = table.Column<int>(nullable: false, comment: "Line number associated with the purchase order, sales order, or work order."),
                    ...
                    TransactionType = table.Column<string>(fixedLength: true, maxLength: 1, nullable: false, comment: "W = Work Order, S = Sales Order, P = Purchase Order"),
                    Quantity = table.Column<int>(nullable: false, comment: "Product quantity."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UnitMeasureCode = table.Column<string>(fixedLength: true, maxLength: 3, nullable: false, comment: "Primary key."),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Unit of measure description."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShipMethodID = table.Column<int>(nullable: false, comment: "Primary key for ShipMethod records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Shipping company name."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CreditCardID = table.Column<int>(nullable: false, comment: "Primary key for CreditCard records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CardType = table.Column<string>(maxLength: 50, nullable: false, comment: "Credit card name."),
                    CardNumber = table.Column<string>(maxLength: 25, nullable: false, comment: "Credit card number."),
                    ExpMonth = table.Column<byte>(nullable: false, comment: "Credit card expiration month."),
                    ExpYear = table.Column<short>(nullable: false, comment: "Credit card expiration year."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CurrencyCode = table.Column<string>(fixedLength: true, maxLength: 3, nullable: false, comment: "The ISO code for the Currency."),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Currency name."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReplicaCurrency", x => x.CurrencyCode);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SalesReasonID = table.Column<int>(nullable: false, comment: "Primary key for SalesReason records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Sales reason description."),
                    ReasonType = table.Column<string>(maxLength: 50, nullable: false, comment: "Category the sales reason belongs to."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SpecialOfferID = table.Column<int>(nullable: false, comment: "Primary key for SpecialOffer records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Description = table.Column<string>(maxLength: 255, nullable: false, comment: "Discount description."),
                    DiscountPct = table.Column<decimal>(type: "smallmoney", nullable: false, defaultValueSql: "((0.00))", comment: "Discount precentage."),
                    Type = table.Column<string>(maxLength: 50, nullable: false, comment: "Discount type category."),
                    Category = table.Column<string>(maxLength: 50, nullable: false, comment: "Group the discount applies to such as Reseller or Customer."),
                    ...
                    MinQty = table.Column<int>(nullable: false, comment: "Minimum discount percent allowed."),
                    MaxQty = table.Column<int>(nullable: true, comment: "Maximum discount percent allowed."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Primary key for Person records."),
                    PersonType = table.Column<string>(fixedLength: true, maxLength: 2, nullable: false, comment: "Primary type of person: SC = Store Contact, IN = Individual (retail) customer, SP = Sales person, EM = Employee (non-sales), VC = Vendor contact, GC = General contact"),
                    NameStyle = table.Column<bool>(nullable: false, comment: "0 = The data in FirstName and LastName are stored in western style (first name, last name) order.  1 = Eastern style (last name, first name) order."),
                    Title = table.Column<string>(maxLength: 8, nullable: true, comment: "A courtesy title. For example, Mr. or Ms."),
                    FirstName = table.Column<string>(maxLength: 50, nullable: false, comment: "First name of the person."),
                    MiddleName = table.Column<string>(maxLength: 50, nullable: true, comment: "Middle name or middle initial of the person."),
                    LastName = table.Column<string>(maxLength: 50, nullable: false, comment: "Last name of the person."),
                    Suffix = table.Column<string>(maxLength: 10, nullable: true, comment: "Surname suffix. For example, Sr. or Jr."),
                    EmailPromotion = table.Column<int>(nullable: false, comment: "0 = Contact does not wish to receive e-mail promotions, 1 = Contact does wish to receive e-mail promotions from AdventureWorks, 2 = Contact does wish to receive e-mail promotions from AdventureWorks and selected partners. "),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Primary key for Vendor records.  Foreign key to BusinessEntity.BusinessEntityID"),
                    AccountNumber = table.Column<string>(maxLength: 15, nullable: false, comment: "Vendor account (identification) number."),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Company name."),
                    CreditRating = table.Column<byte>(nullable: false, comment: "1 = Superior, 2 = Excellent, 3 = Above average, 4 = Average, 5 = Below average"),
                    PreferredVendorStatus = table.Column<bool>(nullable: false, defaultValueSql: "((1))", comment: "0 = Do not use if another vendor is available. 1 = Preferred over other vendors supplying the same product."),
                    ActiveFlag = table.Column<bool>(nullable: false, defaultValueSql: "((1))", comment: "0 = Vendor no longer used. 1 = Vendor is actively used."),
                    PurchasingWebServiceURL = table.Column<string>(maxLength: 1024, nullable: true, comment: "Vendor URL."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TerritoryID = table.Column<int>(nullable: false, comment: "Primary key for SalesTerritory records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Sales territory description"),
                    CountryRegionCode = table.Column<string>(maxLength: 3, nullable: false, comment: "ISO standard country or region code. Foreign key to CountryRegion.CountryRegionCode. "),
                    Group = table.Column<string>(maxLength: 50, nullable: false, comment: "Geographic area to which the sales territory belong."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductSubcategoryID = table.Column<int>(nullable: false, comment: "Primary key for ProductSubcategory records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductCategoryID = table.Column<int>(nullable: false, comment: "Product category identification number. Foreign key to ProductCategory.ProductCategoryID."),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Subcategory description."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductModelID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to ProductModel.ProductModelID."),
                    IllustrationID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to Illustration.IllustrationID."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ProductModelID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to ProductModel.ProductModelID."),
                    ProductDescriptionID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to ProductDescription.ProductDescriptionID."),
                    CultureID = table.Column<string>(fixedLength: true, maxLength: 6, nullable: false, comment: "Culture identification number. Foreign key to Culture.CultureID."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CountryRegionCode = table.Column<string>(maxLength: 3, nullable: false, comment: "ISO code for countries and regions. Foreign key to CountryRegion.CountryRegionCode."),
                    CurrencyCode = table.Column<string>(fixedLength: true, maxLength: 3, nullable: false, comment: "ISO standard currency code. Foreign key to Currency.CurrencyCode."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CurrencyRateID = table.Column<int>(nullable: false, comment: "Primary key for CurrencyRate records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CurrencyRateDate = table.Column<DateTime>(type: "datetime", nullable: false, comment: "Date and time the exchange rate was obtained."),
                    FromCurrencyCode = table.Column<string>(fixedLength: true, maxLength: 3, nullable: false, comment: "Exchange rate was converted from this currency code."),
                    ToCurrencyCode = table.Column<string>(fixedLength: true, maxLength: 3, nullable: false, comment: "Exchange rate was converted to this currency code."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Primary key for Employee records.  Foreign key to BusinessEntity.BusinessEntityID."),
                    NationalIDNumber = table.Column<string>(maxLength: 15, nullable: false, comment: "Unique national identification number such as a social security number."),
                    LoginID = table.Column<string>(maxLength: 256, nullable: false, comment: "Network login."),
                    //OrganizationLevel = table.Column<short>(nullable: true, computedColumnSql: "([OrganizationNode].[GetLevel]())", comment: "The depth of the employee in the corporate hierarchy."),
                    JobTitle = table.Column<string>(maxLength: 50, nullable: false, comment: "Work title such as Buyer or Sales Representative."),
                    BirthDate = table.Column<DateTime>(type: "date", nullable: false, comment: "Date of birth."),
                    MaritalStatus = table.Column<string>(fixedLength: true, maxLength: 1, nullable: false, comment: "M = Married, S = Single"),
                    Gender = table.Column<string>(fixedLength: true, maxLength: 1, nullable: false, comment: "M = Male, F = Female"),
                    HireDate = table.Column<DateTime>(type: "date", nullable: false, comment: "Employee hired on this date."),
                    SalariedFlag = table.Column<bool>(nullable: false, defaultValueSql: "((1))", comment: "Job classification. 0 = Hourly, not exempt from collective bargaining. 1 = Salaried, exempt from collective bargaining."),
                    VacationHours = table.Column<short>(nullable: false, comment: "Number of available vacation hours."),
                    SickLeaveHours = table.Column<short>(nullable: false, comment: "Number of available sick leave hours."),
                    CurrentFlag = table.Column<bool>(nullable: false, defaultValueSql: "((1))", comment: "0 = Inactive, 1 = Active"),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to BusinessEntity.BusinessEntityID."),
                    PersonID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to Person.BusinessEntityID."),
                    ContactTypeID = table.Column<int>(nullable: false, comment: "Primary key.  Foreign key to ContactType.ContactTypeID."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Primary key. Person associated with this email address.  Foreign key to Person.BusinessEntityID"),
                    EmailAddressID = table.Column<int>(nullable: false, comment: "Primary key. ID of this email address.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmailAddress = table.Column<string>(maxLength: 50, nullable: true, comment: "E-mail address for the person."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordHash = table.Column<string>(unicode: false, maxLength: 128, nullable: false, comment: "Password for the e-mail account."),
                    PasswordSalt = table.Column<string>(unicode: false, maxLength: 10, nullable: false, comment: "Random value concatenated with the password string before the password is hashed."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Business entity identification number. Foreign key to Person.BusinessEntityID."),
                    PhoneNumber = table.Column<string>(maxLength: 25, nullable: false, comment: "Telephone number identification number."),
                    PhoneNumberTypeID = table.Column<int>(nullable: false, comment: "Kind of phone number. Foreign key to PhoneNumberType.PhoneNumberTypeID."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Business entity identification number. Foreign key to Person.BusinessEntityID."),
                    CreditCardID = table.Column<int>(nullable: false, comment: "Credit card identification number. Foreign key to CreditCard.CreditCardID."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StateProvinceID = table.Column<int>(nullable: false, comment: "Primary key for StateProvince records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StateProvinceCode = table.Column<string>(fixedLength: true, maxLength: 3, nullable: false, comment: "ISO standard state or province code."),
                    CountryRegionCode = table.Column<string>(maxLength: 3, nullable: false, comment: "ISO standard country or region code. Foreign key to CountryRegion.CountryRegionCode. "),
                    IsOnlyStateProvinceFlag = table.Column<bool>(nullable: false, defaultValueSql: "((1))", comment: "0 = StateProvinceCode exists. 1 = StateProvinceCode unavailable, using CountryRegionCode."),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "State or province description."),
                    TerritoryID = table.Column<int>(nullable: false, comment: "ID of the territory in which the state or province is located. Foreign key to SalesTerritory.SalesTerritoryID."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductID = table.Column<int>(nullable: false, comment: "Primary key for Product records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Name of the product."),
                    ProductNumber = table.Column<string>(maxLength: 25, nullable: false, comment: "Unique product identification number."),
                    MakeFlag = table.Column<bool>(nullable: false, defaultValueSql: "((1))", comment: "0 = Product is purchased, 1 = Product is manufactured in-house."),
                    FinishedGoodsFlag = table.Column<bool>(nullable: false, defaultValueSql: "((1))", comment: "0 = Product is not a salable item. 1 = Product is salable."),
                    Color = table.Column<string>(maxLength: 15, nullable: true, comment: "Product color."),
                    SafetyStockLevel = table.Column<short>(nullable: false, comment: "Minimum inventory quantity. "),
                    ReorderPoint = table.Column<short>(nullable: false, comment: "Inventory level that triggers a purchase order or work order. "),
                    ...
                    Size = table.Column<string>(maxLength: 5, nullable: true, comment: "Product size."),
                    SizeUnitMeasureCode = table.Column<string>(fixedLength: true, maxLength: 3, nullable: true, comment: "Unit of measure for Size column."),
                    WeightUnitMeasureCode = table.Column<string>(fixedLength: true, maxLength: 3, nullable: true, comment: "Unit of measure for Weight column."),
                    Weight = table.Column<decimal>(type: "decimal(8, 2)", nullable: true, comment: "Product weight."),
                    DaysToManufacture = table.Column<int>(nullable: false, comment: "Number of days required to manufacture the product."),
                    ProductLine = table.Column<string>(fixedLength: true, maxLength: 2, nullable: true, comment: "R = Road, M = Mountain, T = Touring, S = Standard"),
                    Class = table.Column<string>(fixedLength: true, maxLength: 2, nullable: true, comment: "H = High, M = Medium, L = Low"),
                    Style = table.Column<string>(fixedLength: true, maxLength: 2, nullable: true, comment: "W = Womens, M = Mens, U = Universal"),
                    ProductSubcategoryID = table.Column<int>(nullable: true, comment: "Product is a member of this product subcategory. Foreign key to ProductSubCategory.ProductSubCategoryID. "),
                    ProductModelID = table.Column<int>(nullable: true, comment: "Product is a member of this product model. Foreign key to ProductModel.ProductModelID."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Employee identification number. Foreign key to Employee.BusinessEntityID."),
                    DepartmentID = table.Column<short>(nullable: false, comment: "Department in which the employee worked including currently. Foreign key to Department.DepartmentID."),
                    ShiftID = table.Column<byte>(nullable: false, comment: "Identifies which 8-hour shift the employee works. Foreign key to Shift.Shift.ID."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayFrequency = table.Column<byte>(nullable: false, comment: "1 = Salary received monthly, 2 = Salary received biweekly"),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    JobCandidateID = table.Column<int>(nullable: false, comment: "Primary key for JobCandidate records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BusinessEntityID = table.Column<int>(nullable: true, comment: "Employee identification number if applicant was hired. Foreign key to Employee.BusinessEntityID."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PurchaseOrderID = table.Column<int>(nullable: false, comment: "Primary key.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RevisionNumber = table.Column<byte>(nullable: false, comment: "Incremental number to track changes to the purchase order over time."),
                    Status = table.Column<byte>(nullable: false, defaultValueSql: "((1))", comment: "Order current status. 1 = Pending; 2 = Approved; 3 = Rejected; 4 = Complete"),
                    EmployeeID = table.Column<int>(nullable: false, comment: "Employee who created the purchase order. Foreign key to Employee.BusinessEntityID."),
                    VendorID = table.Column<int>(nullable: false, comment: "Vendor with whom the purchase order is placed. Foreign key to Vendor.BusinessEntityID."),
                    ShipMethodID = table.Column<int>(nullable: false, comment: "Shipping method. Foreign key to ShipMethod.ShipMethodID."),
                    ...
                    TotalDue = table.Column<decimal>(type: "money", nullable: false, computedColumnSql: "(isnull(([SubTotal]+[TaxAmt])+[Freight],(0)))", comment: "Total due to vendor. Computed as Subtotal + TaxAmt + Freight."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Primary key for SalesPerson records. Foreign key to Employee.BusinessEntityID"),
                    TerritoryID = table.Column<int>(nullable: true, comment: "Territory currently assigned to. Foreign key to SalesTerritory.SalesTerritoryID."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AddressID = table.Column<int>(nullable: false, comment: "Primary key for Address records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AddressLine1 = table.Column<string>(maxLength: 60, nullable: false, comment: "First street address line."),
                    AddressLine2 = table.Column<string>(maxLength: 60, nullable: true, comment: "Second street address line."),
                    City = table.Column<string>(maxLength: 30, nullable: false, comment: "Name of the city."),
                    StateProvinceID = table.Column<int>(nullable: false, comment: "Unique identification number for the state or province. Foreign key to StateProvince table."),
                    PostalCode = table.Column<string>(maxLength: 15, nullable: false, comment: "Postal code for the street address."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SalesTaxRateID = table.Column<int>(nullable: false, comment: "Primary key for SalesTaxRate records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StateProvinceID = table.Column<int>(nullable: false, comment: "State, province, or country/region the sales tax applies to."),
                    TaxType = table.Column<byte>(nullable: false, comment: "1 = Tax applied to retail transactions, 2 = Tax applied to wholesale transactions, 3 = Tax applied to all sales (retail and wholesale) transactions."),
                    TaxRate = table.Column<decimal>(type: "smallmoney", nullable: false, defaultValueSql: "((0.00))", comment: "Tax rate amount."),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Tax rate description."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BillOfMaterialsID = table.Column<int>(nullable: false, comment: "Primary key for BillOfMaterials records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductAssemblyID = table.Column<int>(nullable: true, comment: "Parent product identification number. Foreign key to Product.ProductID."),
                    ComponentID = table.Column<int>(nullable: false, comment: "Component identification number. Foreign key to Product.ProductID."),
                    ...
                    UnitMeasureCode = table.Column<string>(fixedLength: true, maxLength: 3, nullable: false, comment: "Standard code identifying the unit of measure for the quantity."),
                    BOMLevel = table.Column<short>(nullable: false, comment: "Indicates the depth the component is from its parent (AssemblyID)."),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ProductID = table.Column<int>(nullable: false, comment: "Product identification number. Foreign key to Product.ProductID."),
                    LocationID = table.Column<short>(nullable: false, comment: "Inventory location identification number. Foreign key to Location.LocationID. "),
                    Shelf = table.Column<string>(maxLength: 10, nullable: false, comment: "Storage compartment within an inventory location."),
                    Bin = table.Column<byte>(nullable: false, comment: "Storage container on a shelf in an inventory location."),
                    Quantity = table.Column<short>(nullable: false, comment: "Quantity of products in the inventory location."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ProductID = table.Column<int>(nullable: false, comment: "Product identification number. Foreign key to Product.ProductID."),
                    ProductPhotoID = table.Column<int>(nullable: false, comment: "Product photo identification number. Foreign key to ProductPhoto.ProductPhotoID."),
                    Primary = table.Column<bool>(nullable: false, comment: "0 = Photo is not the principal image. 1 = Photo is the principal image."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductReviewID = table.Column<int>(nullable: false, comment: "Primary key for ProductReview records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductID = table.Column<int>(nullable: false, comment: "Product identification number. Foreign key to Product.ProductID."),
                    ReviewerName = table.Column<string>(maxLength: 50, nullable: false, comment: "Name of the reviewer."),
                    ReviewDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date review was submitted."),
                    EmailAddress = table.Column<string>(maxLength: 50, nullable: false, comment: "Reviewer's e-mail address."),
                    Rating = table.Column<int>(nullable: false, comment: "Product rating given by the reviewer. Scale is 1 to 5 with 5 as the highest rating."),
                    Comments = table.Column<string>(maxLength: 3850, nullable: true, comment: "Reviewer's comments"),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransactionID = table.Column<int>(nullable: false, comment: "Primary key for TransactionHistory records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductID = table.Column<int>(nullable: false, comment: "Product identification number. Foreign key to Product.ProductID."),
                    ReferenceOrderID = table.Column<int>(nullable: false, comment: "Purchase order, sales order, or work order identification number."),
                    ReferenceOrderLineID = table.Column<int>(nullable: false, comment: "Line number associated with the purchase order, sales order, or work order."),
                    TransactionDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time of the transaction."),
                    TransactionType = table.Column<string>(fixedLength: true, maxLength: 1, nullable: false, comment: "W = WorkOrder, S = SalesOrder, P = PurchaseOrder"),
                    Quantity = table.Column<int>(nullable: false, comment: "Product quantity."),
                    ActualCost = table.Column<decimal>(type: "money", nullable: false, comment: "Product cost."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WorkOrderID = table.Column<int>(nullable: false, comment: "Primary key for WorkOrder records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductID = table.Column<int>(nullable: false, comment: "Product identification number. Foreign key to Product.ProductID."),
                    OrderQty = table.Column<int>(nullable: false, comment: "Product quantity to build."),
                    StockedQty = table.Column<int>(nullable: false, computedColumnSql: "(isnull([OrderQty]-[ScrappedQty],(0)))", comment: "Quantity built and put in inventory."),
                    ScrappedQty = table.Column<short>(nullable: false, comment: "Quantity that failed inspection."),
                    ...
                    ScrapReasonID = table.Column<short>(nullable: true, comment: "Reason for inspection failure."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to Product.ProductID."),
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to Vendor.BusinessEntityID."),
                    AverageLeadTime = table.Column<int>(nullable: false, comment: "The average span of time (in days) between placing an order with the vendor and receiving the purchased product."),
                    ...
                    MinOrderQty = table.Column<int>(nullable: false, comment: "The maximum quantity that should be ordered."),
                    MaxOrderQty = table.Column<int>(nullable: false, comment: "The minimum quantity that should be ordered."),
                    OnOrderQty = table.Column<int>(nullable: true, comment: "The quantity currently on order."),
                    UnitMeasureCode = table.Column<string>(fixedLength: true, maxLength: 3, nullable: false, comment: "The product's unit of measure."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShoppingCartItemID = table.Column<int>(nullable: false, comment: "Primary key for ShoppingCartItem records.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShoppingCartID = table.Column<string>(maxLength: 50, nullable: false, comment: "Shopping cart identification number."),
                    Quantity = table.Column<int>(nullable: false, defaultValueSql: "((1))", comment: "Product quantity ordered."),
                    ProductID = table.Column<int>(nullable: false, comment: "Product ordered. Foreign key to Product.ProductID."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SpecialOfferID = table.Column<int>(nullable: false, comment: "Primary key for SpecialOfferProduct records."),
                    ProductID = table.Column<int>(nullable: false, comment: "Product identification number. Foreign key to Product.ProductID."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PurchaseOrderID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to PurchaseOrderHeader.PurchaseOrderID."),
                    PurchaseOrderDetailID = table.Column<int>(nullable: false, comment: "Primary key. One line number per purchased product.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DueDate = table.Column<DateTime>(type: "datetime", nullable: false, comment: "Date the product is expected to be received."),
                    OrderQty = table.Column<short>(nullable: false, comment: "Quantity ordered."),
                    ProductID = table.Column<int>(nullable: false, comment: "Product identification number. Foreign key to Product.ProductID."),
                    UnitPrice = table.Column<decimal>(type: "money", nullable: false, comment: "Vendor's selling price of a single product."),
                    LineTotal = table.Column<decimal>(type: "money", nullable: false, computedColumnSql: "(isnull([OrderQty]*[UnitPrice],(0.00)))", comment: "Per product subtotal. Computed as OrderQty * UnitPrice."),
                    ...
                    StockedQty = table.Column<decimal>(type: "decimal(9, 2)", nullable: false, computedColumnSql: "(isnull([ReceivedQty]-[RejectedQty],(0.00)))", comment: "Quantity accepted into inventory. Computed as ReceivedQty - RejectedQty."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Sales person identification number. Foreign key to SalesPerson.BusinessEntityID."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Primary key. The sales rep.  Foreign key to SalesPerson.BusinessEntityID."),
                    TerritoryID = table.Column<int>(nullable: false, comment: "Primary key. Territory identification number. Foreign key to SalesTerritory.SalesTerritoryID."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to Customer.BusinessEntityID."),
                    Name = table.Column<string>(maxLength: 50, nullable: false, comment: "Name of the store."),
                    SalesPersonID = table.Column<int>(nullable: true, comment: "ID of the sales person assigned to the customer. Foreign key to SalesPerson.BusinessEntityID."),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    BusinessEntityID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to BusinessEntity.BusinessEntityID."),
                    AddressID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to Address.AddressID."),
                    AddressTypeID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to AddressType.AddressTypeID."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WorkOrderID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to WorkOrder.WorkOrderID."),
                    ProductID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to Product.ProductID."),
                    OperationSequence = table.Column<short>(nullable: false, comment: "Primary key. Indicates the manufacturing process sequence."),
                    LocationID = table.Column<short>(nullable: false, comment: "Manufacturing location where the part is processed. Foreign key to Location.LocationID."),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerID = table.Column<int>(nullable: false, comment: "Primary key.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PersonID = table.Column<int>(nullable: true, comment: "Foreign key to Person.BusinessEntityID"),
                    StoreID = table.Column<int>(nullable: true, comment: "Foreign key to Store.BusinessEntityID"),
                    TerritoryID = table.Column<int>(nullable: true, comment: "ID of the territory in which the customer is located. Foreign key to SalesTerritory.SalesTerritoryID."),
                    AccountNumber = table.Column<string>(unicode: false, maxLength: 10, nullable: false,  comment: "Unique number identifying the customer assigned by the accounting system."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SalesOrderID = table.Column<int>(nullable: false, comment: "Primary key.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RevisionNumber = table.Column<byte>(nullable: false, comment: "Incremental number to track changes to the sales order over time."),
                    ...
                    Status = table.Column<byte>(nullable: false, defaultValueSql: "((1))", comment: "Order current status. 1 = In process; 2 = Approved; 3 = Backordered; 4 = Rejected; 5 = Shipped; 6 = Cancelled"),
                    OnlineOrderFlag = table.Column<bool>(nullable: false, defaultValueSql: "((1))", comment: "0 = Order placed by sales person. 1 = Order placed online by customer."),
                    SalesOrderNumber = table.Column<string>(maxLength: 25, nullable: false, computedColumnSql: "(isnull(N'SO'+CONVERT([nvarchar](23),[SalesOrderID]),N'*** ERROR ***'))", comment: "Unique sales order identification number."),
                    PurchaseOrderNumber = table.Column<string>(maxLength: 25, nullable: true, comment: "Customer purchase order number reference. "),
                    AccountNumber = table.Column<string>(maxLength: 15, nullable: true, comment: "Financial accounting number reference."),
                    CustomerID = table.Column<int>(nullable: false, comment: "Customer identification number. Foreign key to Customer.BusinessEntityID."),
                    SalesPersonID = table.Column<int>(nullable: true, comment: "Sales person who created the sales order. Foreign key to SalesPerson.BusinessEntityID."),
                    TerritoryID = table.Column<int>(nullable: true, comment: "Territory in which the sale was made. Foreign key to SalesTerritory.SalesTerritoryID."),
                    BillToAddressID = table.Column<int>(nullable: false, comment: "Customer billing address. Foreign key to Address.AddressID."),
                    ShipToAddressID = table.Column<int>(nullable: false, comment: "Customer shipping address. Foreign key to Address.AddressID."),
                    ShipMethodID = table.Column<int>(nullable: false, comment: "Shipping method. Foreign key to ShipMethod.ShipMethodID."),
                    CreditCardID = table.Column<int>(nullable: true, comment: "Credit card identification number. Foreign key to CreditCard.CreditCardID."),
                    CreditCardApprovalCode = table.Column<string>(unicode: false, maxLength: 15, nullable: true, comment: "Approval code provided by the credit card company."),
                    CurrencyRateID = table.Column<int>(nullable: true, comment: "Currency exchange rate used. Foreign key to CurrencyRate.CurrencyRateID."),
                    ...
                    TaxAmt = table.Column<decimal>(type: "money", nullable: false, defaultValueSql: "((0.00))", comment: "Tax amount."),
                    Freight = table.Column<decimal>(type: "money", nullable: false, defaultValueSql: "((0.00))", comment: "Shipping cost."),
                    TotalDue = table.Column<decimal>(type: "money", nullable: false, computedColumnSql: "(isnull(([SubTotal]+[TaxAmt])+[Freight],(0)))", comment: "Total due from customer. Computed as Subtotal + TaxAmt + Freight."),
                    Comment = table.Column<string>(maxLength: 128, nullable: true, comment: "Sales representative comments."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SalesOrderID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to SalesOrderHeader.SalesOrderID."),
                    SalesOrderDetailID = table.Column<int>(nullable: false, comment: "Primary key. One incremental unique number per product sold.")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CarrierTrackingNumber = table.Column<string>(maxLength: 25, nullable: true, comment: "Shipment tracking number supplied by the shipper."),
                    OrderQty = table.Column<short>(nullable: false, comment: "Quantity ordered per product."),
                    ProductID = table.Column<int>(nullable: false, comment: "Product sold to customer. Foreign key to Product.ProductID."),
                    SpecialOfferID = table.Column<int>(nullable: false, comment: "Promotional code. Foreign key to SpecialOffer.SpecialOfferID."),
                    ...
                    LineTotal = table.Column<decimal>(type: "numeric(38, 6)", nullable: false, computedColumnSql: "(isnull(([UnitPrice]*((1.0)-[UnitPriceDiscount]))*[OrderQty],(0.0)))", comment: "Per product subtotal. Computed as UnitPrice * (1 - UnitPriceDiscount) * OrderQty."),
                    rowguid = table.Column<Guid>(nullable: false, defaultValueSql: "(newid())", comment: "ROWGUIDCOL number uniquely identifying the record. Used to support a merge replication sample."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    SalesOrderID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to SalesOrderHeader.SalesOrderID."),
                    SalesReasonID = table.Column<int>(nullable: false, comment: "Primary key. Foreign key to SalesReason.SalesReasonID."),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())", comment: "Date and time the record was last updated.")
                },
                constraints: table =>
                {
